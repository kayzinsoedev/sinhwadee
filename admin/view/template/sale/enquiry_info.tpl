...
<div id="content">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-info-circle"></i> <?php echo $text_enquiry; ?></h3>
      </div>
            ...
            <fieldset>
              ...
              <form class="form-horizontal">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-order-status"><?php echo $entry_enquiry_status; ?></label>
                  <div class="col-sm-10">
                    <select name="enquiry_order_status_id" id="input-order-status" class="form-control">
                      <?php foreach ($enquiry_statuses as $order_statuses) { ?>
                      <?php if ($order_statuses['order_status_id'] == $enquiry_order_status_id) { ?>
...
$(document).delegate('#button-invoice', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/enquiry/createInvoiceNo&token=<?php echo $token; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/enquiry/addreward&token=<?php echo $token; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-reward-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/enquiry/removereward&token=<?php echo $token; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-add', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/enquiry/addcommission&token=<?php echo $token; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$(document).delegate('#button-commission-remove', 'click', function() {
	$.ajax({
		url: 'index.php?route=sale/enquiry/removecommission&token=<?php echo $token; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>',
		type: 'post',
		dataType: 'json',
		beforeSend: function() {
...
$('#history').load('index.php?route=sale/enquiry/history&token=<?php echo $token; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>');
...
$('#button-history').on('click', function() {
	...
	$.ajax({
		url: '<?php echo $catalog; ?>index.php?route=api/enquiry/history&token=' + token + '&store_id=<?php echo $store_id; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>',
		type: 'post',
		dataType: 'json',
		data: 'enquiry_order_status_id=' + encodeURIComponent($('select[name=\'enquiry_order_status_id\']').val()) + '&notify=' + ($('input[name=\'notify\']').prop('checked') ? 1 : 0) + '&override=' + ($('input[name=\'override\']').prop('checked') ? 1 : 0) + '&append=' + ($('input[name=\'append\']').prop('checked') ? 1 : 0) + '&comment=' + encodeURIComponent($('textarea[name=\'comment\']').val()),
		beforeSend: function() {
...
function changeStatus(){
	var status_id = $('select[name="enquiry_order_status_id"]').val();

	$('#openbay-info').remove();

	$.ajax({
		url: 'index.php?route=extension/openbay/getorderinfo&token=<?php echo $token; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>&status_id=' + status_id,
		dataType: 'html',
...
function addOrderInfo(){
	...
	$.ajax({
		url: 'index.php?route=extension/openbay/addorderinfo&token=<?php echo $token; ?>&enquiry_order_id=<?php echo $enquiry_order_id; ?>&status_id=' + status_id,
		type: 'post',
		dataType: 'html',
...
$('select[name="enquiry_order_status_id"]').change(function(){
	changeStatus();
});
//--></script> 
</div>
