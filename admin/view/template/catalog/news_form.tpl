    ...
    <div class="panel panel-default">
	  ...
	  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-blog" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li class=""><a href="#tab-video" data-toggle="tab"><?php echo $tab_video; ?></a></li>
...
<div class="tab-pane active" id="tab-general">
	<ul class="nav nav-tabs" id="language">
      ...
      <!-- seldom use -->
        ...
        <!-- related product -->
        <div class="form-group">
          <label class="col-sm-2 control-label" for="input-related"><span data-toggle="tooltip" title="<?= $help_related; ?>">Related Products</span></label>
          <div class="col-sm-10">
            <input type="text" name="product_related" value="" placeholder="Related Products" id="input-related" class="form-control" />
            <div id="product-related" class="well well-sm" style="height: 150px; overflow: auto;">
              <!-- <?php debug($product_relateds);?> -->
    ...
    <div class="form-group">
          ...
          <div class="col-sm-10">
            ...
            <div style="clear:both">
								   <!-- <a href="" id="thumb-file" data-toggle="image" class="img-thumbnail"><input type="text" name="download_file" value="<?=$download_file ?>" id="download-file" class="form-control" /><span class="upload-btn">upload</span></a> -->
								   <!-- <a href="" id="thumb-file" data-toggle="image" class="img-thumbnail">
                     <input type="file" name="download_file" value="<?=$download_file ?>" id="download-file" class="form-control" />

                   </a> -->
                    <span class="upload-btn"><?=$download_file ?></span>
                   <input type="file" id="download-file" name="download_file" value="<?=$download_file ?>" class="form-control">
				    </div>
          </div>
    </div>
 ...
 <div class="table-responsive">
	<table id="video" class="table table-striped table-bordered table-hover">
            ...
            <tbody id="video-row<?php echo $video_row; ?>">
              <tr>
                <td class="text-left">
				               <input type="text" name="news_video[<?php echo $video_row; ?>][video]" value="<?php echo $video['video']; ?>" >
				</td>
				<td class="text-left">
