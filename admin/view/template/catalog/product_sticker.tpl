                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <td width="115px" class="hidden-">
                            <span data-toggle="tooltip" data-html="true" title="Image will overwrite the text. It will not work as a background image of the sticker"><?= $text_sticker_image; ?><br>(50px X 50px)</span>
                        </td>
