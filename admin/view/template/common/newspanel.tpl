...
<?php } elseif ($validatingblog === "ne") { ?>
<span class="bnline">There is one last thing you need to do, register the blog events. Please click the following button</span><br/>
<a class="blogbutton" href="<?php echo $reg_events; ?>">Register News/Blog Events</a>
<?php } elseif ($validatingblog === "ok") { ?>
<div class="bwinfo">
 <img src="view/blog-res/blog.png" alt="Blog" />
 <a class="bwlink hidden" href="<?php echo $npages; ?>" title="<?php echo $entry_npages; ?>"><i class="fa fa-book"></i><span class="bli">Art</span></a>
 <a class="bwlink bwodd hidden" href="<?php echo $ncategory; ?>" title="<?php echo $entry_ncategory; ?>"><i class="fa fa-folder-open"></i><span class="bli">Cat</span></a>
 <a class="bwlink hidden" href="<?php echo $tocomments; ?>" title="<?php echo $text_commod; ?>"><i class="fa fa-comments"></i><span class="bli" style="margin-left: -10px;">Com</span></a>
 <a class="bwlink bwodd hidden" href="<?php echo $nauthor; ?>" title="<?php echo $text_nauthor; ?>"><i class="fa fa-user"></i><span class="bli" style="margin-left: -9px;">Aut</span></a>
 ...
 <a class="bwlink bwodd hidden" href="<?php echo $nmod; ?>" title="<?php echo $entry_nmod; ?>"><i class="fa fa-bookmark-o"></i><span class="bli" style="margin-left: -10px;">Lnm</span></a>
 <a class="bwlink hidden" href="<?php echo $namod; ?>" title="<?php echo $entry_namod; ?>"><i class="fa fa-archive"></i><span class="bli" style="margin-left: -12px;">Bam</span></a>
 <div class="bwstats hidden">
	<table>
