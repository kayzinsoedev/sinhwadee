  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="button" form="form-customer" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary btn-submit" onclick="$('#form-customer').submit();"><i class="fa fa-save"></i></button>
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer" class="form-horizontal">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab-general" data-toggle="tab"><?php echo $tab_customer_info; ?></a></li>
            <?php if ($customer_id) { ?>
            <li><a href="#tab-history" data-toggle="tab"><?php echo $tab_activity; ?></a></li>
            <li><a href="#tab-transaction" data-toggle="tab"  class="hidden"><?php echo $tab_transaction; ?></a></li>
            <li><a href="#tab-reward" data-toggle="tab"><?php echo $tab_reward; ?></a></li>
            <li><a href="#tab-ip" data-toggle="tab" class="hidden"><?php echo $tab_ip; ?></a></li>
            <?php } ?>
          </ul>
                  ...
                  <div class="tab-content">
                    <div class="tab-pane active" id="tab-customer">
                      ...
                      <div class="form-group <?= $event_day_status ? 'required':'hidden' ?>">
                        ...
                        <div class="col-sm-10">
                          <input type="text" name="birthday" value="<?php echo $birthday; ?>" placeholder="<?php echo $entry_birthday; ?>" id="input-birthday" class="form-control birthday" />
                          <?php if ($error_birthday) { ?>
                          <div class="text-danger"><?php echo $error_birthday; ?></div>
                          <?php  } ?>
                        </div>
                      </div>
                      <?php include_once('customer_form_account_custom_field.tpl'); ?>
                    ...
                    <?php include_once('customer_form_address.tpl'); ?>
                  </div>
                </div>
              </div>
            </div>
...
function addAddress() {
  ...
  html += '  </div>';
	...
	html += '  <div class="form-group">';
	html += '    <label class="col-sm-2 control-label" for="input-unit-no' + address_row + '"><?php echo $entry_unit_no; ?></label>';
	html += '    <div class="col-sm-10"><input type="text" name="address[' + address_row + '][unit_no]" value="" placeholder="<?php echo $entry_unit_no; ?>" id="input-unit-no' + address_row + '" class="form-control" /></div>';
	html += '  </div>';
  ...
  postalcode('#input-postcode' + address_row + '', '#input-address-1' + address_row + '', '#input-address-2' + address_row);
