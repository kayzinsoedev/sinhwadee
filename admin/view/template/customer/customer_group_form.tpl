        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer-group" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-reward">
              ...
              <div class="form-group <?= $loyalty_crons == "" ? 'hidden':'' ?>">
                  <label class="col-sm-2 control-label" for="input-min_spend_amount" ><span data-toggle="tooltip" title="System will consider total sales amount not reward points">Min Amount Spent to Reach This Level</span></label>
                  <div class="col-sm-10">
                    <input type="text" name="min_spend_amount" value="<?php echo $min_spend_amount; ?>" placeholder="Min Amount Spent to Reach This Level" id="input-min_spend_amount" class="form-control" />
                  </div>
              </div>
              ...
              <div class="form-group <?=$is_dev?>">
                ...
                <div class="col-sm-10">
                  <div style="color:red;">
                    <p>
                      <?php echo $text_cron_note; ?>
                      <?php echo $loyalty_crons; ?>
                      <?php echo $event_day_crons; ?>
                    </p>
                  </div>
                </div>
              </div>
