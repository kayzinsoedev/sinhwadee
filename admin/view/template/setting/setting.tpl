        ...
        <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal" autocomplete="off">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email-sales"><?= $entry_sales_email; ?></label>
                <div class="col-sm-10">
                  <input name="config_sales_email" value="<?= $config_sales_email; ?>" placeholder="<?= $entry_sales_email; ?>" id="input-email-sales" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email-brand"><?= $entry_brand_email; ?></label>
                <div class="col-sm-10">
                  <input name="config_brand_email" value="<?= $config_brand_email; ?>" placeholder="<?= $entry_brand_email; ?>" id="input-email-brand" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email-purchase"><?= $entry_purchase_email; ?></label>
                <div class="col-sm-10">
                  <input name="config_purchase_email" value="<?= $config_purchase_email; ?>" placeholder="<?= $entry_purchase_email; ?>" id="input-email-purchase" class="form-control" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-email-career"><?= $entry_career_email; ?></label>
                <div class="col-sm-10">
                  <input name="config_career_email" value="<?= $config_career_email; ?>" placeholder="<?= $entry_career_email; ?>" id="input-email-career" class="form-control" />
                </div>
              </div>
              <div class="form-group required">
            ...
            <div class="tab-pane" id="tab-image">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-footer_admin-icon"><span data-toggle="tooltip title="<?= $help_icon; ?>">Footer Admin <?= $entry_icon; ?></span></label>
                <div class="col-sm-10"><a href="" id="thumb-footer_admin-icon" data-toggle="image" class="img-thumbnail"><img src="<?= $footer_admin_icon; ?>" alt="" title="" data-placeholder="<?= $placeholder; ?>" /></a>
                  <input type="hidden" name="config_footer_admin_icon" value="<?= $config_footer_admin_icon; ?>" id="input-footer_admin-icon" />
                </div>
              </div>
