		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-recently_viewed" class="form-horizontal">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-autoplay">Autoplay Speed (ms)<br><i>(1s = 1000, leave blank for disabled autoplay)</i></label>
						<div class="col-sm-10">
							<input type="text" name="autoplay" value="<?php echo $autoplay; ?>" placeholder="Autoplay Speed" id="input-limit" class="form-control" />
						</div>
					</div>
