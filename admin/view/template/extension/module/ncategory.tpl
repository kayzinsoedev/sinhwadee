	 ...
	 <div class="panel panel-default">
	  ...
	  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-ncat" class="form-horizontal">
		 ...
		 <ul class="nav nav-tabs">
            ...
            <li class="hidden"><a href="#tab-disqus" data-toggle="tab"><i class="fa fa-comments"></i> <?php echo $tab_disqus; ?></a></li>
            <li class="hidden"><a href="#tab-fb" data-toggle="tab"><i class="fa fa-facebook-square"></i> <?php echo $tab_facebook; ?></a></li>
            <li class="hidden"><a href="#tab-other" data-toggle="tab"><i class="fa fa-info-circle"></i> <?php echo $tab_other; ?></a></li>
          </ul>
