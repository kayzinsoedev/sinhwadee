        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              ...
              <?php if ($error_transcation_id) { ?>
              <div class="text-danger"><?php echo $error_transcation_id; ?></div>
              <?php } ?>
            </div>
          </div>
          ...
          <div class="form-group required" <?php echo ($refund_available == '' ? 'style="display:none;" ' : ''); ?>id="partial_amount_row">
          ...
          <div class="form-group required">
            ...
            <div class="col-sm-10">
              <textarea name="description" id="hoolah_refund_message" cols="40" rows="5"></textarea>
            </div>
          </div>
