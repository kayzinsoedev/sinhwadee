...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_sales_email'] = $this->language->get('entry_sales_email');
		$data['entry_brand_email'] = $this->language->get('entry_brand_email');
		$data['entry_purchase_email'] = $this->language->get('entry_purchase_email');
		$data['entry_career_email'] = $this->language->get('entry_career_email');
		...
		if (isset($this->request->post['config_sales_email'])) {
			$data['config_sales_email'] = $this->request->post['config_sales_email'];
		} else {
			$data['config_sales_email'] = $this->config->get('config_sales_email');
		}

		if (isset($this->request->post['config_brand_email'])) {
			$data['config_brand_email'] = $this->request->post['config_brand_email'];
		} else {
			$data['config_brand_email'] = $this->config->get('config_brand_email');
		}

		if (isset($this->request->post['config_purchase_email'])) {
			$data['config_purchase_email'] = $this->request->post['config_purchase_email'];
		} else {
			$data['config_purchase_email'] = $this->config->get('config_purchase_email');
		}

		if (isset($this->request->post['config_career_email'])) {
			$data['config_career_email'] = $this->request->post['config_career_email'];
		} else {
			$data['config_career_email'] = $this->config->get('config_career_email');
		}
		...
		if (isset($this->request->post['config_footer_admin_icon'])) {
			$data['config_footer_admin_icon'] = $this->request->post['config_footer_admin_icon'];
		} else {
			$data['config_footer_admin_icon'] = $this->config->get('config_footer_admin_icon');
		}

		if (isset($this->request->post['config_footer_admin_icon']) && is_file(DIR_IMAGE . $this->request->post['config_footer_admin_icon'])) {
			$data['footer_admin_icon'] = $this->model_tool_image->resize($this->request->post['config_footer_admin_icon'], 100, 100);
		} elseif ($this->config->get('config_footer_admin_icon') && is_file(DIR_IMAGE . $this->config->get('config_footer_admin_icon'))) {
			$data['footer_admin_icon'] = $this->model_tool_image->resize($this->config->get('config_footer_admin_icon'), 100, 100);
		} else {
			$data['footer_admin_icon'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
