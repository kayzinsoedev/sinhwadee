...
$_['entry_delivery_date']					= 'Display Delivery Date';
...
$_['entry_delivery_times_cutoff']			= 'Cut Off Time (HH:MM:SS)<br>24 Hour format<br>(Only work when user select Today date)';
$_['entry_action']			                = 'Actions';
