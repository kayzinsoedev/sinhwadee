...
$_['text_cron_note']    = 'To clear reward points, you are required to set CRON job URL: <br>wget -qO- ' .HTTP_CATALOG . 'index.php?route=_cron/cron/clearCustomerReward &> /dev/null<br>Frequency can be set as once per day<br>Please contact technical support if assistance is needed';
