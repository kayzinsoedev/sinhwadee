...
$_['text_type_admin.career.fulltime'] = 'Career Application';
...
$_['info_msg_admin.career.fulltime']	= '
<div class="infotags">
<h5>Career Apply Now</h5>
<p>
<span><b class="tag">{fname}</b> User name</span>
<span><b class="tag">{subject}</b> User subject</span>
<span><b class="tag">{contact}</b> User telephone</span>
<span><b class="tag">{email}</b> User email</span>
<span><b class="tag">{position}</b> Message</span>
</p>
</div>';
