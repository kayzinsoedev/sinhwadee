<head>
	...
	<meta property="og:price:currency" content="<?=$og_currency;?>">
	<meta property="product:brand" content="<?=$og_brand;?>">
    <meta property="product:availability" content="<?=$og_availability;?>">
    <meta property="product:condition" content="new">
    <meta property="product:price:amount" content="<?=$og_price;?>">
    <meta property="product:price:currency" content="<?=$og_currency;?>">
    <meta property="product:retailer_item_id" content="<?=$og_retailer_id;?>">
    <?php } ?>
	...
	<link href="catalog/view/theme/default/stylesheet/breadcrumb.css" rel="stylesheet">
	...
	<style>
		...
		.cd-accordion-menu a, .cd-accordion-menu label { background-color: #<?= $mobile_menu_background_color2 ?> !important; }
	</style>
	<?php } ?>
</head>
