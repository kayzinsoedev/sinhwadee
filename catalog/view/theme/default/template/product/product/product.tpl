...
$(window).load(function(){
	setTimeout(function () {
		product_inner_banner_slick();
		AOS.init();
	}, 250);
});

function product_inner_banner_slick(){
	$("#product_inner_banner_slick").on('init', function (event, slick) {
		$('#product_inner_banner_slick').parent().removeAttr('style');
	});

	$("#product_inner_banner_slick").slick({
		// dots: true,
		infinite: false,
		speed: 300,
