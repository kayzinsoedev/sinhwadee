<div class="container-fluid oem-section">
    <div class="col-md-3 about-sidebar">
      <?php foreach ($main_categories as $key=> $main_category){ ?>
          <div class="category-div">
              <a href="index.php?route=information/information&information_id=8#<?=$main_category['main_category_name'];?>""><p class="sidebar-about-main-cat"><?=$main_category['main_category_name']; ?></p></a>
              <?php foreach ($oem_services as $key=> $service) { ?>
                    <?php if($main_category['id'] == $service['main_categories'] ){ ?>
                          <a href="index.php?route=information/information&information_id=8#about-sub-title<?=$key;?>"><p class="sidebar-aboutsub_title"><?= $service['sub_title']; ?></p></a>
                    <?php } ?>
              <?php }?>
          </div>
      <?php } ?>
