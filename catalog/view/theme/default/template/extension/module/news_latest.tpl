  ...
  <?php if($cat_id=="59"){ ?>
    <div id="news_latest" class="bnews-list hidden-sm hidden-xs">
        ...
        <div class="artblock">
          ...
          <div class="info">
            ...
            <?php if ($articles['date_added']) { ?>
              <span><img src="image/catalog/project/general/calendar.png" alt="calendar" class="img-calendar"/>
              <?php echo $articles['date_added']; ?></span>
            <?php } ?>
          </div>
          <div class="hidden">
