<div class="major-supermarket">
    <h2><?= $sec_title; ?> </h2>
    <div class="majorsupermarket-logo vertical-align container-fluid">
        <div class="part-container">
            <div class="home-users-slide-container slideshow">
                <div id="majorsupermarket" class="relative owl-carousel"  style="opacity: 1; width: 100%;">
                    <?php foreach ($client_logo as $client_logos) { ?>
                    <div class="majorsupermarket-slide">
                        <a href="<?= $client_logos['link']; ?>">
