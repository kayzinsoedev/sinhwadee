...
<div class="clientele-logo vertical-align container-fluid">
        <div class="part-container">
            <div class="home-users-slide-container slideshow">
                <div id="oem-clientele" class="relative owl-carousel"  style="opacity: 1; width: 100%;">
                    <?php foreach ($client_logo as $client_logos) { ?>
                    <div class="clientele-users-slide" data-toggle="modal" data-target="#OemClientele-<?=$client_logos['id'];?>">
...
<?php foreach($client_logo as $client_logos) {?>
<div class="modal fade custom-service" id="OemClientele-<?=$client_logos['id'];?>" role="dialog">
