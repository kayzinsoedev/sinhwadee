...
class ControllerCommonFooter extends Controller {
	public function index() {
		...
		$data['text_sales_enq'] = $this->language->get('text_sales_enq');
		$data['text_brand_enq'] = $this->language->get('text_brand_enq');
		$data['text_purchase_enq'] = $this->language->get('text_purchase_enq');
		$data['text_career_enq'] = $this->language->get('text_career_enq');
		...
		$data['footer_admin_icon'] = $this->config->get('config_footer_admin_icon');
	...
	public function afterFooterImg() {
		$this->load->library('modulehelper');
		$Modulehelper = Modulehelper::get_instance($this->registry);
		$oc = $this;
		$language_id = $this->config->get('config_language_id');
        ...
        $footers = $Modulehelper->get_field ( $oc, $modulename, $language_id, 'footers');
        $data['footers'] = array();
        if(!empty($footers)) {
