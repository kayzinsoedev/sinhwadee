...
class ControllerNewsArticle extends Controller {
	...
	protected function getPageContent($news_info) {
		...
		// $data['related_products_slider'] = $this->load->controller('extension/module/related_blog',$this->request->get['product_id']);

		$data['related_products'] = $this->load->controller('extension/module/featured/related_products_list', $this->request->get['news_id']);
