<?php
class ControllerQuickEnquiryRegister extends Controller {
	private $error;
  	...
  	public function index() {
		...
		return $this->load->view('quickenquiry/register', $data);
  	}
	...
	public function validate() {
		...
		if (!$json) {
			...
			$json['redirect'] = $this->url->link('quickenquiry/checkout');
