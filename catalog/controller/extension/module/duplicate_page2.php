<?php
class ControllerExtensionModuleDuplicatePage2 extends Controller {
	public function index() {
        $this->load->library('modulehelper');
        $Modulehelper = Modulehelper::get_instance($this->registry);
        $oc = $this;
        $language_id = $this->config->get('config_language_id');
        $modulename  = 'duplicate_page2';

        $services = $Modulehelper->get_field ( $oc, $modulename, $language_id, 'duplicate_page2');
		...
		return $this->load->view('extension/module/duplicate_page2', $data);
    }
