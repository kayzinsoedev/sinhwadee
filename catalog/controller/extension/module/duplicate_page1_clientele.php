<?php
class ControllerExtensionModuleDuplicatePage1Clientele extends Controller {
	public function index() {
        ...
        $modulename  = 'duplicate_page1_clientele';
        ...
        if(!empty($client_logo)) {
            ...
            $data['client_logo'] = $client_logo;
		     ...
		     return $this->load->view('extension/module/duplicate_page1_clientele', $data);
    }
