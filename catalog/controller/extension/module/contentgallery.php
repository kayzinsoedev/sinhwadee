            ...
            // $data['contents'] = $contents;
				...
				foreach ($contents as $key => $value) {
						$data['contents'][$key] = array(
								'top_image' => $this->model_tool_image->resize($value['top_image'], 400, 600),
								'top_image_desc' => $value['top_image_desc'],
								'top_image_link' => $value['top_image_link'],
								'alignment' => $value['alignment'],
								'big_bg' => $value['big_bg'],
								'small_image1' => $this->model_tool_image->resize($value['small_image1'], 400, 300),
								'small_desc1' => $value['small_desc1'],
								'small_image_link' => $value['small_image_link'],
								'small_alignment' => $value['small_alignment'],
								'small_image2' => $this->model_tool_image->resize($value['small_image2'], 400, 300),
