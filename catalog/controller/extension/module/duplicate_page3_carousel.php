<?php
class ControllerExtensionModuleDuplicatePage3Carousel extends Controller {
	public function index() {
        ...
        $modulename  = 'duplicate_page3_carousel';
        ...
        if(!empty($client_logo)) {
            ...
            $data['client_logo'] = $client_logo;
		     ...
		     return $this->load->view('extension/module/duplicate_page3_carousel', $data);
    }
