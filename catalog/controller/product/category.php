...
class ControllerProductCategory extends Controller {
	...
	public function index() {
		...
		$data['shop_page_banners'] = $Modulehelper->get_field ( $oc, $modulename, $language_id, 'shop_page_banners');
		...
		$data['shop_locations'] = $Modulehelper->get_field ( $oc, $modulename, $language_id, 'shop_locations');
		$data['module_status'] = $Modulehelper->get_field ( $oc, $modulename, $language_id, 'module_status');
