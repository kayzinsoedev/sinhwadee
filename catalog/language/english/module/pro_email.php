...
// admin.career.fulltime
$_['subject_admin.career.fulltime'] = 'Application From - {fname} {lname}';
$_['text_new_enquiry'] = 'You received a new application.';
$_['text_subject'] = '<b>First Name:</b> {fname}';
$_['text_name'] = '<b>Last Name:</b> {lname}';
$_['text_mail'] = '<b>Email Address:</b> {email}';
$_['text_contact'] = '<b>Contact Number:</b> {contact}';
$_['text_address'] = '<b>Address:</b> {address}';
$_['text_position'] = '<b>Position:</b> {position}';
$_['text_cvfile'] = '<b>File:</b><br/><a href="{fileNamePath}{cvfile}" style="color:#000;text-decoration:underline;">{cvfile}</a>';
